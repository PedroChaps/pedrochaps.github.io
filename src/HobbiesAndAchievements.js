                    ...
                    <div className={clicked1 ? "text-lg text-left m-5 pb-5 " : "hidden"}>
                        ...
                        <div className="pl-4 text-center md:text-left ">
                            ...
                            <div className="md:flex items-start gap-4">
                                ...
                                <p className=""> <b>{ReactHtmlParser(content.HobbiesAndAchievements.Hobbies.CTFsHackingPlatforms.Title)}</b> - {ReactHtmlParser(content.HobbiesAndAchievements.Hobbies.CTFsHackingPlatforms.pt1)} <a className="underline hover:font-bold" href="https://cryptohack.org/user/ch4ps/" >CryptoHack</a> {ReactHtmlParser(content.HobbiesAndAchievements.Hobbies.CTFsHackingPlatforms.pt2)}, <a className="underline hover:font-bold" href="https://portswigger.net/web-security/" >Portswigger Academy</a> {ReactHtmlParser(content.HobbiesAndAchievements.Hobbies.CTFsHackingPlatforms.pt3)}, <a className="underline hover:font-bold" href="https://www.hackthebox.com/" >HackTheBox</a> {ReactHtmlParser(content.HobbiesAndAchievements.Hobbies.CTFsHackingPlatforms.pt4)} <a className="underline hover:font-bold" href="https://tryhackme.com/" >TryHackMe</a>.</p>
                            </div>
                    ...
                    <div className={clicked2 ? "text-lg text-left m-5 pb-5" : "hidden"}>
                        ...
                        <div className="pl-4 text-center md:text-left ">
                            ...
                            <div className="md:flex items-start gap-4">
                                ...
                                <p className=""> <b>{content.HobbiesAndAchievements.Achievements.ResumosLEIC.Title} </b> - {ReactHtmlParser(content.HobbiesAndAchievements.Achievements.ResumosLEIC.pt1)} <a className="underline hover:font-bold" href="https://resumos.leic.pt/rc/" >Resumos LEIC</a>{ReactHtmlParser(content.HobbiesAndAchievements.Achievements.ResumosLEIC.pt2)}.</p>
                            </div><br /> 
                        </div>
                    </div>
                </div>

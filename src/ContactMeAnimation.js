import { OrbitControls, PerspectiveCamera, OrthographicCamera, Stars, ScrollControls, Html } from '@react-three/drei';
...
function ContactMe() {
    ...
    const opts = {fontSize: 30, lineHeight: 1.6, fontWeight:11, letterSpacing:0.1}
    const opts2 = {fontSize: 0.2, lineHeight: 1.6, fontWeight:11, letterSpacing:0.1, color:"black"}
    ...
    <div ref={canvasRef} className="w-[100%] md:sticky md:top-0 md:h-[100vh] md:min-h-fit bg-black text-white justify-evenly items-center z-30">
      ...
      <Suspense fallback={<div> I am Loading... </div>}>
        ...
        onMouseMove={onMouseMove}>{/*TODO: add position: [0,0,0], */}
          ...
          <text text={"Liked what you saw?"} {...opts2} position-x={0} position-y={-0.1} position-z={zPosition + 0.4} anchorX="center" anchorY="middle">   
	  	          <meshPhongMaterial attach="material" />
            </text>
            <text text={"CONTACT ME !"} {...opts} position-x={-6.5} position-y={-10.4} position-z={zPosition} anchorX="center" anchorY="middle">   
	  	          <meshPhongMaterial attach="material" />
            </text>

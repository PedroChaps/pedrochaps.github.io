        ...
        <div id="CareerAndEducation" className="relative">
                ...
                <div className="absolute z-[1] top-48 text-almostWhite m-5 md:m-20 rounded-3xl left-[0%] right-[0%] backdrop-filter backdrop-blur-lg bg-white/20 text-center center">
                    ...
                    <div className={clicked1 ? "text-lg text-left m-5 pb-5" : "hidden"}>
                        ...
                        <div className="pl-2 text-center md:text-left">
                            <div className="md:flex items-start gap-4">
                                <p className="">I work in the Networking and Communications Department (NRC) of my University as part of a Research Grant. <br /><br className="md:hidden" />
                                    I investigate and develop new methodologies that enable the management of network infrastructures, which lead to increased availability and network performance, as well as adding new services to the IST community. <br /><br className="md:hidden" />
                        ...
                        <div className="pl-2 text-center md:text-left">
                            <div className="md:flex items-start gap-4">
                                <p className=""> As soon as I finished high school and started University, I started working as a Math Tutor, helping students with Math difficulties offering them online classes. <br /><br className="md:hidden" />
                                    In total, I've given classes to 8 different students ranging from 8th to 12th grade. <br /><br className="md:hidden" />
                                    In the beginning, I started using the platform Superprof to find and interact with the students but as I had grew a set of students, I eventually moved to being 100% independent.<br /></p>
                            </div>
                        </div>
                    ...
                    */}
                    ...
                    <div className={clicked2 ? "text-lg text-left m-5 pb-5" : "hidden"}>
                        ...
                        <div className="pl-2 text-center md:text-left">
                            <div className="md:flex items-start gap-4">
                                <p className=""> I am studying Computer Science in <i>Instituto Superior Técnico</i>, one of the best Engineering Universities. <br /> <br className="md:hidden" />
            ...
            <div className="h-[135rem] md:h-[75rem]">
                <Suspense fallback={<div> I am Loading... </div>}>
                    <Canvas onWheel={(e) => handleScroll(e)} style={{ background: "black", top: "0", zIndex: "0" }} camera={{ fov: 75, near: 0.1, far: 1000, position: position }}>
                        <PerspectiveCamera />
                        {/* <OrbitControls/> */}
